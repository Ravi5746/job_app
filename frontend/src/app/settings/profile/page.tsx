...
//           </div>
//           <div>
//             <label className={labelClass}>Location (General)</label>
...
//             <input type="text" value={profile.address_line_1 || ''} onChange={e => setProfile({ ...profile, address_line_1: e.target.value })} className={inputClass} />
//           </div>
//           <div>
//             <label className={labelClass}>Address Line 2</label>
//             <input type="text" value={profile.address_line_2 || ''} onChange={e => setProfile({ ...profile, address_line_2: e.target.value })} className={inputClass} />
//           </div>
//           <div>
...
//             <input type="text" value={profile.state_province || ''} onChange={e => setProfile({ ...profile, state_province: e.target.value })} className={inputClass} />
//           </div>
//           <div>
...
//       <SectionHeader title="Demographic / EEO Data" icon={User} section="eeo" />
...
//             <input type="text" placeholder="Comma separated: Full Stack Developer, Backend Engineer" value={(profile.desired_job_titles || []).join(', ')}
//               onChange={e => setProfile({ ...profile, desired_job_titles: e.target.value.split(',').map(m => m.trim()).filter(Boolean) })}
//               className={inputClass} />
//           </div>
//           <div>
...
//           </div>
//           <div>
//             <label className={labelClass}>Requires Visa Sponsorship?</label>
//             <select value={profile.requires_sponsorship === null ? '' : profile.requires_sponsorship ? 'yes' : 'no'}
//               onChange={e => setProfile({ ...profile, requires_sponsorship: e.target.value === '' ? null : e.target.value === 'yes' })}
//               className={inputClass}>
